...
export const SONGS: Song[] = [
  {
    ...
    note: "Me recuerda a nuestro primer viaje a Granada",
  },
  {
    id: 2,
    title: "Enamorao",
    spotify_track_id: "01pCF0R0XmZUDDsEVB6ROW",
    note: "Enamorao como me tienes.",
  },
  {
    id: 3,
    title: "Te Como la Cara",
    spotify_track_id: "1a19HeCrAgB1xS5r0VkLIP",
    note: "Me da la gana constantemente de morderte la cara y el cuello.",
  },
  {
    id: 4,
    title: "Corazón Mío",
    spotify_track_id: "0y7jUC6wgVW2NlvZa67cWN",
    note: "Corazón Mío es lo que eres para mí... y no dudo en decirtelo a gritos, a besos y a caricias.",
  },
  {
    id: 5,
    title: "El camino",
    spotify_track_id: "6x5gl9msgjsqub1hy7Iq3k",
    note: "El camino es largo, pero contigo todo es mejor.",
  },
  {
    id: 6,
    title: "Agradecío",
    spotify_track_id: "6sx7Glmf0es3vkqD3annAW",
    note: "Y a ti te dedico esta canción, por amarme así.",
  },
  {
    id: 7,
    title: "蓝",
    spotify_track_id: "5ku3lEb3OW2dpPapxTNyKL",
    note: "Original, la escuchaba al principio cuando empezamos.",
  },
  {
    id: 8,
    title: "13/18",
    spotify_track_id: "0rO36aEzoamawMEAo8ivCL",
    note: "Esta canción me suena a superarse, y nosotros hemos superado ya demasiadas cosas.",
  },
];
